...
}else if (withItem === "Firecracker" || "Firecracker Pebble"){
	api.broadcastMessage(killedName + " went off with a bang", {color: "Red"});
}else if (withItem === "Instant Damage Potion" || "Instant Damage Potion II" || "Splash Instant Damage Potion" || "Splash Instant Damage Potion II"){
